...
for (k in 1:5) {
  set(pbp, j = paste0("home_", k), value = resolve_player(vapply(pbp$lineup_home, `[`, character(1), k)))
  set(pbp, j = paste0("away_", k), value = resolve_player(vapply(pbp$lineup_away, `[`, character(1), k)))
}
...
# 4N design: o1, o2, o3 (usage tiers) + defense
od_long_usage <- rbind(
